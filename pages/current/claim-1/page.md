# Claim 1 — Theorem 3.1 Fisher consistency
...
| --- | --- |
| Contract and source audit | [claim contract](https://huggingface.co/spaces/DineshAI/xixoixLXCr/blob/main/evidence/current/artifacts/claim_1/claim_contract.json), [source audit](https://huggingface.co/spaces/DineshAI/xixoixLXCr/blob/main/evidence/current/artifacts/claim_1/source_audit.md) |
| Executable verifier | [verifier source](https://huggingface.co/spaces/DineshAI/xixoixLXCr/blob/main/evidence/current/artifacts/claim_1/checker.py) |
| Certificate/raw JSON | [positive certificate](https://huggingface.co/spaces/DineshAI/xixoixLXCr/blob/main/evidence/current/artifacts/claim_1/proof_certificate.json) |
| Negative control | [mutated certificate](https://huggingface.co/spaces/DineshAI/xixoixLXCr/blob/main/evidence/current/artifacts/claim_1/negative_control.json) |
...
| Method and limitations | [method](https://huggingface.co/spaces/DineshAI/xixoixLXCr/blob/main/evidence/current/artifacts/claim_1/method.md), [limitations](https://huggingface.co/spaces/DineshAI/xixoixLXCr/blob/main/evidence/current/artifacts/claim_1/limitations.md) |
